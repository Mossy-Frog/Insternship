...
DfComplete<-read.table("C:/Users/maxence.lechemia/Documents/Multi-omics/normalized counts by deseq2 with proteo.txt")
...
save(MEs, moduleLabels, moduleColors, geneTree, file = "step2bwgcna4.RData")
...
lnames = load(file = "C:/Users/maxence.lechemia/Documents/scripts formalisés/step2bwgcna4.RData");
lnames
...
datTraits[c("seq","repiq","treatment","type")]<-""
datTraits$seq[c(1:24,31:54,61:67,79:86,93:98)]<-1
datTraits$seq[c(25:30,55:60,67:78,87:92)]<-2
datTraits$treatment[c(1:6,19:36,49:98)]<-1
datTraits$treatment[c(7:12,37:42)]<-2
datTraits$treatment[c(13:18,43:48)]<-3
datTraits$repiq[c(1:18,31:48,61:66,79:80,82:83,85,87:98)]<-1
datTraits$repiq[c(19:30,49:60,67:72,81,84)]<-2
datTraits$repiq[c(73:78,86)]<-3
datTraits$type[c(1:78,87:92)]<-1
datTraits$type[c(79:86)]<-2
datTraits$type[c(93:98)]<-3
...
output<-"C:/Users/maxence.lechemia/Documents/Multi-omics/ClusterisationGeneGTP/"
...
write.csv(geneModuleMembership,"C:/Users/maxence.lechemia/Documents/Multi-omics/genemoduleMembershipGTP.csv")
